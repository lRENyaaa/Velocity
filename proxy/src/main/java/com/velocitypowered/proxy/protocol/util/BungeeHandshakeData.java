...
/**
 * Process the handshake format used by BungeeCord.
 */
public class BungeeHandshakeData {
  ...
  private BungeeHandshakeData(
      String serverHostname,
      String socketAddressHostname,
      UUID uniqueId, List<GameProfile.Property> properties,
      @Nullable String floodgatePlayerData,
      @Nullable String forwardingSecret
  ) {
  ...
  public String encode(final @Nullable String forwardingSecret) {
    ...
    String encodeSecret = forwardingSecret == null ? this.forwardingSecret : forwardingSecret;
    List<GameProfile.Property> encodeProperties = addForwardingSecret(properties, encodeSecret);
